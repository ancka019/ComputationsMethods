...
namespace hw2
{
    internal class Program
    {
        public static void Main()
        {
            ...
            Console.WriteLine("Хотите изменить точку интерполирования x? YES/NO");
            answ = Console.ReadLine();
            if (answ == "YES")
            {
            ...
            Console.WriteLine("Cтепень многочлена n: {0}", n);
            Console.WriteLine("Хотите изменить степень многочлена n? YES/NO");
            answ = Console.ReadLine();
            if (answ == "YES")
            {
