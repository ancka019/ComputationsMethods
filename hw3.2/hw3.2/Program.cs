...
namespace hw3._2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Хотите изменить параметр a? y/n");
            ...
            Console.WriteLine("Хотите изменить параметр h? y/n");
            ...
            Console.WriteLine("Хотите изменить параметр m? y/n");
            answ = Console.ReadLine();
            if (answ == "y")
            {
            ...
            while (answ != "y")
            {
                ...
                Console.WriteLine("Хотите создать новую таблицу значений функции? y/n");
                answ = Console.ReadLine();
                if (answ == "y")
                {
                    Console.WriteLine("Хотите изменить параметр a? y/n");
