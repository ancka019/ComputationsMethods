...
namespace hw3
{
    class Program
    {
        public static void Main()
        {
            ...
            double f(double p)
            {
                double res = Math.Exp(-p) - Math.Pow(p, 2) / 2;
                return res;
            }
            ...
            Console.WriteLine("Хотите изменить параметры a и b? y/n");
            ...
            Console.WriteLine("Хотите изменить параметр eps? y/n");
            answ = Console.ReadLine();
            if (answ == "y")
            {
            ...
            Console.WriteLine("Хотите изменить значение F? y/n");
            answ = Console.ReadLine();
            if (answ == "y")
            {
